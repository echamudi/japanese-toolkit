    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        db.serialize(() => {
          ...
          kanji.kanken.lv10.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 100 };
          });
          kanji.kanken.lv09.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 90 };
          });
          kanji.kanken.lv08.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 80 };
          });
          kanji.kanken.lv07.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 70 };
          });
          kanji.kanken.lv06.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 60 };
          });
          kanji.kanken.lv05.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 50 };
          });
          kanji.kanken.lv04.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 40 };
          });
          kanji.kanken.lv03.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 30 };
          });
          kanji.kanken.lv02pre.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 25 };
          });
          kanji.kanken.lv02.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 20 };
          });
          kanji.kanken.lv01pre.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 15 };
          });
          kanji.kanken.lv01.forEach((/** @type {string} */ char) => {
            all[char] = { kanken: 10 };
          });

          kanji.jlpt.n5.forEach((/** @type {string} */ char) => {
            all[char].jlptNew = 5;
          });
          kanji.jlpt.n4.forEach((/** @type {string} */ char) => {
            all[char].jlptNew = 4;
          });
          kanji.jlpt.n3.forEach((/** @type {string} */ char) => {
            all[char].jlptNew = 3;
          });
          kanji.jlpt.n2.forEach((/** @type {string} */ char) => {
            all[char].jlptNew = 2;
          });
          kanji.jlpt.n1.forEach((/** @type {string} */ char) => {
            all[char].jlptNew = 1;
          });
