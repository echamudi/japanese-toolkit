                ...
                db.serialize(() => {
                    ...
                    kanjidicEntries.forEach(
                        (/** @type {any} */ kanjidicEntry, /** @type {number} */ index) => {
                            ...
                            kanjidicEntry.codepoint[0].cp_value.forEach(
                                (/** @type {any} */ cpValue) => {
                            ...
                            kanjidicEntry.radical[0].rad_value.forEach(
                                (/** @type {any} */ radValue) => {
                            ...
                            const dicNumber = kanjidicEntry.dic_number
                                ? JSON.stringify(kanjidicEntry.dic_number[0].dic_ref, null, 0)
                                : null;
                            ...
                            const queryCode = kanjidicEntry.query_code
                                ? JSON.stringify(kanjidicEntry.query_code[0].q_code, null, 0)
                                : null;
                            ...
                            if (kanjidicEntry.reading_meaning) {
                                const readingObj = kanjidicEntry.reading_meaning[0].rmgroup[0]
                                    .reading;
                                reading = readingObj ? JSON.stringify(readingObj, null, 0) : null;

                                let meaningObj = kanjidicEntry.reading_meaning[0].rmgroup[0]
                                    .meaning;
